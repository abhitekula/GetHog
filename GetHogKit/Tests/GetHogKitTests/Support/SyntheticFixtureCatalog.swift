enum SyntheticFixtureCatalog {
    ...
    static let packageFixtureNames: Set<String> = [
        ...
        "signal_reports.json",
        "single_session_summaries.json",
        "single_session_summary.json",
        "single_session_summary_frustrated.json",
    ...
    static let replayFixtureNames: Set<String> = [
        ...
        "session_recordings_filtered.json", "single_session_summaries.json",
        "single_session_summary.json", "single_session_summary_frustrated.json",
