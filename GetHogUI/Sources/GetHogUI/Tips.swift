...
public struct AppTipView: View {
    let tip: any Tip

    public init(_ tip: any Tip) { self.tip = tip }
...
public struct ChartScrubTip: Tip {
    @Parameter public static var isAvailable: Bool = false

    public var title: Text { Text("Read exact values") }
